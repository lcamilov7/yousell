...
class CategoryComponentTest < ViewComponent::TestCase
  test 'component render an empty category <a> tag' do
    assert_equal(
      %(<a class=\"bg-orange-500 text-white px-4 py-2 rounded-2xl drop-shadow-sm hover:bg-orange-500\" href=\"/\">All</a>),
  ...
  test 'component render category <a> tag' do
    assert_equal(
      %(<a class=\"category bg-neutral-600 text-gray-200 px-4 py-2 rounded-2xl drop-shadow-sm hover:bg-orange-500\" href=\"/?category_id=630261496\">Videogames</a>),
